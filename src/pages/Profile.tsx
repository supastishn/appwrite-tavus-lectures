...
import { User, Key, Mail, Save, XCircle, CheckCircle, Loader, LogOut } from 'lucide-react';
import { useAppwriteUser } from '../contexts/UserContext';
import { updateUserName, updatePassword } from '../services/auth';
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-5">
              <div className="flex flex-col items-center mb-6">
                <div className="w-24 h-24 rounded-full bg-gradient-to-r from-primary to-primary-dark flex items-center justify-center mb-3">
